...
import br.com.treinamento.cadastrarcliente.model.ClienteMock;
...
public class ClienteMockController {
    ...
    public ResponseEntity<?> adicionar(@RequestBody ClienteMock novoCliente){
        ...
        return new ResponseEntity<>(novoCliente.getNome() + " Criado com sucesso.", HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> atualizar(@PathVariable("id") Long cpf, @RequestBody ClienteMock clienteAtualizado){
        ...
        return new ResponseEntity<>(clienteAtualizado.getNome() + " atualizado com sucesso.", HttpStatus.OK);
    }
 
    @DeleteMapping("/clientes/{id}")
    public ResponseEntity<?> deletar(@PathVariable("id") Long cpf){
        ClienteMock cliente = clientes.remove(cpf);
        return new ResponseEntity<>(cliente.getNome() + " removido com sucesso.", HttpStatus.OK);
    }
